...
COPY --chown=${NB_USER}:users ./CondaPkg.toml ./CondaPkg.toml
...
RUN julia --project=${USER_HOME_DIR} -e "import Pkg; Pkg.Registry.update(); Pkg.instantiate(); Pkg.precompile(); import CondaPkg; CondaPkg.update()"
